...
wss.on("connection", (socket) => {
    ...
    socket.on("close", () => {
        ...
        if (currentRoomId && allSockets[currentRoomId]) {
            allSockets[currentRoomId] = allSockets[currentRoomId].filter((s) => s !== socket);
        ...
        if (currentRoomId &&
            ...
            console.log(`${currentPersonName} disconnected and stopped typing in room ${currentRoomId}`);
